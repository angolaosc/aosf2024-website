...
const LinkItem: React.FC<Link> = ({ name, url }) => {
  return (
    <li className="list-none">
      <a href={url} className="text-zinc-300 transition-all hover:underline hover:text-white">
        {name}
      </a>
    </li>
  );
...
const CardItem: React.FC<Voluntario> = ({ nameV, area, path }) => {
  return (
    <div className="flex p-3 rounded-lg bg-[#0B1317]  items-start gap-4">
      <div>
        <Image src={path} alt="imagem-voluntário" width={40} height={40} className="rounded-full" />
      </div>
      <div>
            ...
            <div>
              ...
              <div className="pt-5">
                <a href="#" className="text-white transition-all hover:underline">
                  angolaopensourcefoundation@gmail.com
                </a>
                <div className="flex items-center flex-wrap gap-4 pt-4">
                  <p className="text-white">+244 933 428 646</p>
        ...
        <div className="border-t border-[#17222F] mt-10 max-w-7xl gap-5 pt-5 grid grid-cols-1 paisagem-tablet:grid-cols-2 w-full m-auto">
          ...
          <div className="social_media">
            <div className="flex paisagem-tablet:justify-end justify-center items-center gap-5 flex-wrap">
              ...
              <BallIcon
                pathIcon="/icons/linkedin.svg"
                link="https://www.linkedin.com/company/angola-open-source-community/"
              />
